			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="fog_dashboard.jsp">Home</a></li>
						<li class="nav-item"><a class="nav-link" href="client_approval.jsp">Approve Clients</a></li>
						<li class="nav-item"><a class="nav-link" href="manage_fog_nodes.jsp">Manage Fog Nodes </a></li>
						<li class="nav-item"><a class="nav-link" href="FogViewRequests.jsp">Key Management </a></li>
						
						<li class="nav-item"><a class="nav-link" href="ViewAccessLayer.jsp">View Access Layer </a></li>
						<li class="nav-item"><a class="nav-link" href="approved_files.jsp">Approved Device </a></li>
...
<%
    if (session.getAttribute("fog_admin") == null) {
        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="login-card">
                     <h2>Welcome Fog Admin Dashboard</h2>
