...
<div class="sidebar">
    ...
    <a href="ClientViewKeys.jsp" class="active">🔑 Client View Data</a>
    <a href="client_verify_keys.jsp">⬇️ Verify Data & Download</a>
...
<div class="main-content">
    ...
    <div class="container">
        <div class="container-box">
            ...
            <h2>🔑 Shared Encryption Keys</h2>

            <%
            Connection con = DBConnection.connect();
            PreparedStatement ps = con.prepareStatement(
                "SELECT file_name, public_key, private_key " +
                "FROM shared_keys WHERE client_email=?"
            );
...
<%=rs.getString("private_key")%>
            ...
            if(!hasData){ %>
                    <tr>
                        <td colspan="3" class="text-muted text-center fw-bold">
                            No keys shared yet
                        </td>
                    </tr>
            <% } %>
