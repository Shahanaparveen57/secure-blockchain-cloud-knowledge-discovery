			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="client_files.jsp">View Shared Files</a></li>
						<li class="nav-item"><a class="nav-link" href="request_access.jsp">Request Data Access </a></li>
						<li class="nav-item"><a class="nav-link" href="blockchainevents.jsp">View Blockchain Logs </a></li>
						<li class="nav-item"><a class="nav-link" href="ClientViewKeys.jsp">Client View Data </a></li>
						<li class="nav-item"><a class="nav-link" href="client_verify_keys.jsp">Client Verify  Data & Download </a></li>
...
<%
    ...
    String clientName = (String) session.getAttribute("client_name");
